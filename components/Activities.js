  ...
  return (
    <View style={tw`p-3`}>
      <View style={tw`flex-row`}>
        <Text style={tw`text-xl ml-3 mt-3 font-bold`}>Activities</Text>
        <Icon
          style={tw`mt-3`}
      ...
      <View style={tw`flex-row items-center rounded rounded-6 bg-black mt-3`}>
        ...
        <TouchableOpacity style={tw`bg-black rounded rounded-3 p-2 py-3 w-45`}>
            ...
            <View style={tw`my-2`}>
              <Text style={tw`font-semibold mb-1 text-white text-base`}>Move</Text>
              <Text style={tw`font-bold text-2xl text-[#F72E79]`}>141/780 KCAL</Text>
            </View>

            <View style={tw`my-2`}>              
              <Text style={tw`font-semibold mb-1 text-white text-base`}>Exercise</Text>
              <Text style={tw`font-bold text-2xl text-[#A8F804]`}>15/30 MIN</Text>
            </View>

            <View style={tw`my-2`}>
              <Text style={tw`font-semibold mb-1 text-white text-base`}>Stand</Text>
